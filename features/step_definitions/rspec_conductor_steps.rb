...
Then "I should see the line coverage results for the rspec-conductor project" do
  steps %(
...
Then "I should see the branch coverage results for the rspec-conductor project" do
  steps %(
    Then I should see the groups:
      | name      | coverage | files |
      | All Files | 89.36%   | 9     |
